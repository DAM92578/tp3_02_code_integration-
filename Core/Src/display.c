...
#define PCF8574_I2C_BUS_8BIT_WRITE_ADDRESS 126
  ...
  void displayPinWrite( uint8_t pinName, int value )
 {
     switch( display.connection ) {
         case DISPLAY_CONNECTION_GPIO_8BITS:
             switch( pinName ) {
                 case DISPLAY_PIN_D0:
                     HAL_GPIO_WritePin(D10_GPIO_Port,D10_Pin,value);
                     break;
                 case DISPLAY_PIN_D1:
                     HAL_GPIO_WritePin(D11_GPIO_Port,D11_Pin,value);
                     break;
                 case DISPLAY_PIN_D2:
                     HAL_GPIO_WritePin(D2_GPIO_Port,D2_Pin,value);
                     break;               
                 case DISPLAY_PIN_D3:
                     HAL_GPIO_WritePin(D12_GPIO_Port, D12_Pin, value);
                     break;
                 case DISPLAY_PIN_D4:
